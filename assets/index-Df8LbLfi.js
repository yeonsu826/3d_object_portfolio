...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yr,depthTest:!1,depthWrite:!1})}function rw(s,e,t){const i=new Float32Array(ws),o=new j(0,1,0);return new Zi({name:"SphericalGaussianBlur",defines:{n:ws,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:Xc(),fragmentShader:`
	...
	`}class L0 extends Ki{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},o=[i,i,i,i,i,i];this.texture=new S0(o),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},o=new Ya(5,5,5),a=new Zi({name:"CubemapFromEquirect",uniforms:Co(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:qn,blending:yr});a.uniforms.tEquirect.value=t;const c=new ri(o,a),d=t.minFilter;return t.minFilter===vr&&(t.minFilter=pn),new eM(1,10,this).update(e,c),t.minFilter=d,c.geometry.dispose(),c.material.dispose(),this}clear(e,t=!0,i=!0,o=!0){const a=e.getRenderTarget();for(let c=0;c<6;c++)e.setRenderTarget(this,c),e.clear(t,i,o);e.setRenderTarget(a)}}function sw(s){let e=new WeakMap,t=new WeakMap,i=null;function o(m,x=!1){return m==null?null:x?c(m):a(m)}function a(m){if(m&&m.isTexture){const x=m.mapping;if(x===Ld||x===Nd)if(e.has(m)){const M=e.get(m).texture;return d(M,m.mapping)}else{const M=m.image;if(M&&M.height>0){const T=new L0(M.height);return T.fromEquirectangularTexture(s,m),e.set(m,T),m.addEventListener("dispose",h),d(T.texture,m.mapping)}else return null}}return m}function c(m){if(m&&m.isTexture){const x=m.mapping,M=x===Ld||x===Nd,T=x===Cs||x===wo;if(M||T){let y=t.get(m);const S=y!==void 0?y.texture.pmremVersion:0;if(m.isRenderTargetTexture&&m.pmremVersion!==S)return i===null&&(i=new g_(s)),y=M?i.fromEquirectangular(m,y):i.fromCubemap(m,y),y.texture.pmremVersion=m.pmremVersion,t.set(m,y),y.texture;if(y!==void 0)return y.texture;{const R=m.image;return M&&R&&R.height>0||T&&R&&f(R)?(i===null&&(i=new g_(s)),y=M?i.fromEquirectangular(m):i.fromCubemap(m),y.texture.pmremVersion=m.pmremVersion,t.set(m,y),m.addEventListener("dispose",g),y.texture):null}}}return m}function d(m,x){return x===Ld?m.mapping=Cs:x===Nd&&(m.mapping=wo),m}function f(m){let x=0;const M=6;for(let T=0;T<M;T++)m[T]!==void 0&&x++;return x===M}function h(m){const x=m.target;x.removeEventListener("dispose",h);const M=e.get(x);M!==void 0&&(e.delete(x),M.dispose())}function g(m){const x=m.target;x.removeEventListener("dispose",g);const M=t.get(x);M!==void 0&&(t.delete(x),M.dispose())}function _(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:o,dispose:_}}function ow(s){const e={};function t(i){if(e[i]!==void 0)return e[i];const o=s.getExtension(i);return e[i]=o,o}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const o=t(i);return o===null&&lh("WebGLRenderer: "+i+" extension not supported."),o}}}function aw(s,e,t,i){const o={},a=new WeakMap;function c(_){const m=_.target;m.index!==null&&e.remove(m.index);for(const M in m.attributes)e.remove(m.attributes[M]);m.removeEventListener("dispose",c),delete o[m.id];const x=a.get(m);x&&(e.remove(x),a.delete(m)),i.releaseStatesOfGeometry(m),m.isInstancedBufferGeometry===!0&&delete m._maxInstanceCount,t.memory.geometries--}function d(_,m){return o[m.id]===!0||(m.addEventListener("dispose",c),o[m.id]=!0,t.memory.geometries++),m}function f(_){const m=_.attributes;for(const x in m)e.update(m[x],s.ARRAY_BUFFER)}function h(_){const m=[],x=_.index,M=_.attributes.position;let T=0;if(M===void 0)return;if(x!==null){const R=x.array;T=x.version;for(let L=0,P=R.length;L<P;L+=3){const k=R[L+0],N=R[L+1],O=R[L+2];m.push(k,N,N,O,O,k)}}else{const R=M.array;T=M.version;for(let L=0,P=R.length/3-1;L<P;L+=3){const k=L+0,N=L+1,O=L+2;m.push(k,N,N,O,O,k)}}const y=new(M.count>=65535?_0:g0)(m,1);y.version=T;const S=a.get(_);S&&e.remove(S),a.set(_,y)}function g(_){const m=a.get(_);if(m){const x=_.index;x!==null&&m.version<x.version&&h(_)}else h(_);return a.get(_)}return{get:d,update:f,getWireframeAttribute:g}}function lw(s,e,t){let i;function o(_){i=_}let a,c;function d(_){a=_.type,c=_.bytesPerElement}function f(_,m){s.drawElements(i,m,a,_*c),t.update(m,i,1)}function h(_,m,x){x!==0&&(s.drawElementsInstanced(i,m,a,_*c,x),t.update(m,i,x))}function g(_,m,x){if(x===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,m,0,a,_,0,x);let T=0;for(let y=0;y<x;y++)T+=m[y];t.update(T,i,1)}this.setMode=o,this.setIndex=d,this.render=f,this.renderInstances=h,this.renderMultiDraw=g}function cw(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(a,c,d){switch(t.calls++,c){case s.TRIANGLES:t.triangles+=d*(a/3);break;case s.LINES:t.lines+=d*(a/2);break;case s.LINE_STRIP:t.lines+=d*(a-1);break;case s.LINE_LOOP:t.lines+=d*a;break;case s.POINTS:t.points+=d*a;break;default:nt("WebGLInfo: Unknown draw mode:",c);break}}function o(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:o,update:i}}function uw(s,e,t){const i=new WeakMap,o=new zt;function a(c,d,f){const h=c.morphTargetInfluences,g=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,_=g!==void 0?g.length:0;let m=i.get(d);if(m===void 0||m.count!==_){let X=function(){b.dispose(),i.delete(d),d.removeEventListener("dispose",X)};var x=X;m!==void 0&&m.texture.dispose();const M=d.morphAttributes.position!==void 0,T=d.morphAttributes.normal!==void 0,y=d.morphAttributes.color!==void 0,S=d.morphAttributes.position||[],R=d.morphAttributes.normal||[],L=d.morphAttributes.color||[];let P=0;M===!0&&(P=1),T===!0&&(P=2),y===!0&&(P=3);let k=d.attributes.position.count*P,N=1;k>e.maxTextureSize&&(N=Math.ceil(k/e.maxTextureSize),k=e.maxTextureSize);const O=new Float32Array(k*N*4*_),b=new h0(O,k,N,_);b.type=pi,b.needsUpdate=!0;const D=P*4;for(let F=0;F<_;F++){const $=S[F],ce=R[F],de=L[F],G=k*N*4*F;for(let ie=0;ie<$.count;ie++){const Y=ie*D;M===!0&&(o.fromBufferAttribute($,ie),O[G+Y+0]=o.x,O[G+Y+1]=o.y,O[G+Y+2]=o.z,O[G+Y+3]=0),T===!0&&(o.fromBufferAttribute(ce,ie),O[G+Y+4]=o.x,O[G+Y+5]=o.y,O[G+Y+6]=o.z,O[G+Y+7]=0),y===!0&&(o.fromBufferAttribute(de,ie),O[G+Y+8]=o.x,O[G+Y+9]=o.y,O[G+Y+10]=o.z,O[G+Y+11]=de.itemSize===4?o.w:1)}}m={count:_,texture:b,size:new at(k,N)},i.set(d,m),d.addEventListener("dispose",X)}if(c.isInstancedMesh===!0&&c.morphTexture!==null)f.getUniforms().setValue(s,"morphTexture",c.morphTexture,t);else{let M=0;for(let y=0;y<h.length;y++)M+=h[y];const T=d.morphTargetsRelative?1:1-M;f.getUniforms().setValue(s,"morphTargetBaseInfluence",T),f.getUniforms().setValue(s,"morphTargetInfluences",h)}f.getUniforms().setValue(s,"morphTargetsTexture",m.texture,t),f.getUniforms().setValue(s,"morphTargetsTextureSize",m.size)}return{update:a}}function dw(s,e,t,i,o){let a=new WeakMap;function c(h){const g=o.render.frame,_=h.geometry,m=e.get(h,_);if(a.get(m)!==g&&(e.update(m),a.set(m,g)),h.isInstancedMesh&&(h.hasEventListener("dispose",f)===!1&&h.addEventListener("dispose",f),a.get(h)!==g&&(t.update(h.instanceMatrix,s.ARRAY_BUFFER),h.instanceColor!==null&&t.update(h.instanceColor,s.ARRAY_BUFFER),a.set(h,g))),h.isSkinnedMesh){const x=h.skeleton;a.get(x)!==g&&(x.update(),a.set(x,g))}return m}function d(){a=new WeakMap}function f(h){const g=h.target;g.removeEventListener("dispose",f),i.releaseStatesOfObject(g),t.remove(g.instanceMatrix),g.instanceColor!==null&&t.remove(g.instanceColor)}return{update:c,dispose:d}}const fw={[$_]:"LINEAR_TONE_MAPPING",[Z_]:"REINHARD_TONE_MAPPING",[J_]:"CINEON_TONE_MAPPING",[vh]:"ACES_FILMIC_TONE_MAPPING",[e0]:"AGX_TONE_MAPPING",[t0]:"NEUTRAL_TONE_MAPPING",[Q_]:"CUSTOM_TONE_MAPPING"};function hw(s,e,t,i,o){const a=new Ki(e,t,{type:s,depthBuffer:i,stencilBuffer:o,depthTexture:i?new Ro(e,t):void 0}),c=new Ki(e,t,{type:Er,depthBuffer:!1,stencilBuffer:!1}),d=new gi;d.setAttribute("position",new Li([-1,3,0,-1,-1,0,3,-1,0],3)),d.setAttribute("uv",new Li([0,2,0,0,2,0],2));const f=new LS({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new ri(d,f),g=new jc(-1,1,1,-1,0,1);let _=null,m=null,x=!1,M,T=null,y=[],S=!1;this.setSize=function(R,L){a.setSize(R,L),c.setSize(R,L);for(let P=0;P<y.length;P++){const k=y[P];k.setSize&&k.setSize(R,L)}},this.setEffects=function(R){y=R,S=y.length>0&&y[0].isRenderPass===!0;const L=a.width,P=a.height;for(let k=0;k<y.length;k++){const N=y[k];N.setSize&&N.setSize(L,P)}},this.begin=function(R,L){if(x||R.toneMapping===Yi&&y.length===0)return!1;if(T=L,L!==null){const P=L.width,k=L.height;(a.width!==P||a.height!==k)&&this.setSize(P,k)}return S===!1&&R.setRenderTarget(a),M=R.toneMapping,R.toneMapping=Yi,!0},this.hasRenderPass=function(){return S},this.end=function(R,L){R.toneMapping=M,x=!0;let P=a,k=c;for(let N=0;N<y.length;N++){const O=y[N];if(O.enabled!==!1&&(O.render(R,k,P,L),O.needsSwap!==!1)){const b=P;P=k,k=b}}if(_!==R.outputColorSpace||m!==R.toneMapping){_=R.outputColorSpace,m=R.toneMapping,f.defines={},Et.getTransfer(_)===Dt&&(f.defines.SRGB_TRANSFER="");const N=fw[m];N&&(f.defines[N]=""),f.needsUpdate=!0}f.uniforms.tDiffuse.value=P.texture,R.setRenderTarget(T),R.render(h,g),T=null,x=!1},this.isCompositing=function(){return x},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),c.dispose(),d.dispose(),f.dispose()}}const N0=new Sn,fh=new Ro(1,1),I0=new h0,D0=new eS,U0=new S0,y_=[],S_=[],M_=new Float32Array(16),E_=new Float32Array(9),T_=new Float32Array(4);function Bo(s,e,t){const i=s[0];if(i<=0||i>0)return s;const o=e*t;let a=y_[o];if(a===void 0&&(a=new Float32Array(o),y_[o]=a),e!==0){i.toArray(a,0);for(let c=1,d=0;c!==e;++c)d+=t,s[c].toArray(a,d)}return a}function mn(s,e){if(s.length!==e.length)return!1;for(let t=0,i=s.length;t<i;t++)if(s[t]!==e[t])return!1;return!0}function gn(s,e){for(let t=0,i=e.length;t<i;t++)s[t]=e[t]}function Yc(s,e){let t=S_[e];t===void 0&&(t=new Int32Array(e),S_[e]=t);for(let i=0;i!==e;++i)t[i]=s.allocateTextureUnit();return t}function pw(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function mw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mn(t,e))return;s.uniform2fv(this.addr,e),gn(t,e)}}function gw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(mn(t,e))return;s.uniform3fv(this.addr,e),gn(t,e)}}function _w(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mn(t,e))return;s.uniform4fv(this.addr,e),gn(t,e)}}function vw(s,e){const t=this.cache,i=e.elements;if(i===void 0){if(mn(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),gn(t,e)}else{if(mn(t,i))return;T_.set(i),s.uniformMatrix2fv(this.addr,!1,T_),gn(t,i)}}function xw(s,e){const t=this.cache,i=e.elements;if(i===void 0){if(mn(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),gn(t,e)}else{if(mn(t,i))return;E_.set(i),s.uniformMatrix3fv(this.addr,!1,E_),gn(t,i)}}function yw(s,e){const t=this.cache,i=e.elements;if(i===void 0){if(mn(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),gn(t,e)}else{if(mn(t,i))return;M_.set(i),s.uniformMatrix4fv(this.addr,!1,M_),gn(t,i)}}function Sw(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function Mw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mn(t,e))return;s.uniform2iv(this.addr,e),gn(t,e)}}function Ew(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(mn(t,e))return;s.uniform3iv(this.addr,e),gn(t,e)}}function Tw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mn(t,e))return;s.uniform4iv(this.addr,e),gn(t,e)}}function ww(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function bw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mn(t,e))return;s.uniform2uiv(this.addr,e),gn(t,e)}}function Aw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(mn(t,e))return;s.uniform3uiv(this.addr,e),gn(t,e)}}function Rw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mn(t,e))return;s.uniform4uiv(this.addr,e),gn(t,e)}}function Cw(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o);let a;this.type===s.SAMPLER_2D_SHADOW?(fh.compareFunction=t.isReversedDepthBuffer()?Ah:bh,a=fh):a=N0,t.setTexture2D(e||a,o)}function Pw(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o),t.setTexture3D(e||D0,o)}function Lw(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o),t.setTextureCube(e||U0,o)}function Nw(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o),t.setTexture2DArray(e||I0,o)}function Iw(s){switch(s){case 5126:return pw;case 35664:return mw;case 35665:return gw;case 35666:return _w;case 35674:return vw;case 35675:return xw;case 35676:return yw;case 5124:case 35670:return Sw;case 35667:case 35671:return Mw;case 35668:case 35672:return Ew;case 35669:case 35673:return Tw;case 5125:return ww;case 36294:return bw;case 36295:return Aw;case 36296:return Rw;case 35678:case 36198:case 36298:case 36306:case 35682:return Cw;case 35679:case 36299:case 36307:return Pw;case 35680:case 36300:case 36308:case 36293:return Lw;case 36289:case 36303:case 36311:case 36292:return Nw}}function Dw(s,e){s.uniform1fv(this.addr,e)}function Uw(s,e){const t=Bo(e,this.size,2);s.uniform2fv(this.addr,t)}function Fw(s,e){const t=Bo(e,this.size,3);s.uniform3fv(this.addr,t)}function Ow(s,e){const t=Bo(e,this.size,4);s.uniform4fv(this.addr,t)}function kw(s,e){const t=Bo(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function Bw(s,e){const t=Bo(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function zw(s,e){const t=Bo(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function Vw(s,e){s.uniform1iv(this.addr,e)}function Hw(s,e){s.uniform2iv(this.addr,e)}function Gw(s,e){s.uniform3iv(this.addr,e)}function Ww(s,e){s.uniform4iv(this.addr,e)}function jw(s,e){s.uniform1uiv(this.addr,e)}function Xw(s,e){s.uniform2uiv(this.addr,e)}function Yw(s,e){s.uniform3uiv(this.addr,e)}function Kw(s,e){s.uniform4uiv(this.addr,e)}function qw(s,e,t){const i=this.cache,o=e.length,a=Yc(t,o);mn(i,a)||(s.uniform1iv(this.addr,a),gn(i,a));let c;this.type===s.SAMPLER_2D_SHADOW?c=fh:c=N0;for(let d=0;d!==o;++d)t.setTexture2D(e[d]||c,a[d])}function $w(s,e,t){const i=this.cache,o=e.length,a=Yc(t,o);mn(i,a)||(s.uniform1iv(this.addr,a),gn(i,a));for(let c=0;c!==o;++c)t.setTexture3D(e[c]||D0,a[c])}function Zw(s,e,t){const i=this.cache,o=e.length,a=Yc(t,o);mn(i,a)||(s.uniform1iv(this.addr,a),gn(i,a));for(let c=0;c!==o;++c)t.setTextureCube(e[c]||U0,a[c])}function Jw(s,e,t){const i=this.cache,o=e.length,a=Yc(t,o);mn(i,a)||(s.uniform1iv(this.addr,a),gn(i,a));for(let c=0;c!==o;++c)t.setTexture2DArray(e[c]||I0,a[c])}function Qw(s){switch(s){case 5126:return Dw;case 35664:return Uw;case 35665:return Fw;case 35666:return Ow;case 35674:return kw;case 35675:return Bw;case 35676:return zw;case 5124:case 35670:return Vw;case 35667:case 35671:return Hw;case 35668:case 35672:return Gw;case 35669:case 35673:return Ww;case 5125:return jw;case 36294:return Xw;case 36295:return Yw;case 36296:return Kw;case 35678:case 36198:case 36298:case 36306:case 35682:return qw;case 35679:case 36299:case 36307:return $w;case 35680:case 36300:case 36308:case 36293:return Zw;case 36289:case 36303:case 36311:case 36292:return Jw}}class eb{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Iw(t.type)}}class tb{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Qw(t.type)}}class nb{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const o=this.seq;for(let a=0,c=o.length;a!==c;++a){const d=o[a];d.setValue(e,t[d.id],i)}}}const ff=/(\w+)(\])?(\[|\.)?/g;function w_(s,e){s.seq.push(e),s.map[e.id]=e}function ib(s,e,t){const i=s.name,o=i.length;for(ff.lastIndex=0;;){const a=ff.exec(i),c=ff.lastIndex;let d=a[1];const f=a[2]==="]",h=a[3];if(f&&(d=d|0),h===void 0||h==="["&&c+2===o){w_(t,h===void 0?new eb(d,s,e):new tb(d,s,e));break}else{let _=t.map[d];_===void 0&&(_=new nb(d),w_(t,_)),t=_}}}class Nc{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let c=0;c<i;++c){const d=e.getActiveUniform(t,c),f=e.getUniformLocation(t,d.name);ib(d,f,this)}const o=[],a=[];for(const c of this.seq)c.type===e.SAMPLER_2D_SHADOW||c.type===e.SAMPLER_CUBE_SHADOW||c.type===e.SAMPLER_2D_ARRAY_SHADOW?o.push(c):a.push(c);o.length>0&&(this.seq=o.concat(a))}setValue(e,t,i,o){const a=this.map[t];a!==void 0&&a.setValue(e,i,o)}setOptional(e,t,i){const o=t[i];o!==void 0&&this.setValue(e,i,o)}static upload(e,t,i,o){for(let a=0,c=t.length;a!==c;++a){const d=t[a],f=i[d.id];f.needsUpdate!==!1&&d.setValue(e,f.value,o)}}static seqWithValue(e,t){const i=[];for(let o=0,a=e.length;o!==a;++o){const c=e[o];c.id in t&&i.push(c)}return i}}function b_(s,e,t){const i=s.createShader(e);return s.shaderSource(i,t),s.compileShader(i),i}const rb=37297;let sb=0;function ob(s,e){const t=s.split(`
`),i=[],o=Math.max(e-6,0),a=Math.min(e+6,t.length);for(let c=o;c<a;c++){const d=c+1;i.push(`${d===e?">":" "} ${d}: ${t[c]}`)}return i.join(`
`)}const A_=new ut;function ab(s){Et._getMatrix(A_,Et.workingColorSpace,s);const e=`mat3( ${A_.elements.map(t=>t.toFixed(4))} )`;switch(Et.getTransfer(s)){case Oc:return[e,"LinearTransferOETF"];case Dt:return[e,"sRGBTransferOETF"];default:return $e("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function R_(s,e,t){const i=s.getShaderParameter(e,s.COMPILE_STATUS),a=(s.getShaderInfoLog(e)||"").trim();if(i&&a==="")return"";const c=/ERROR: 0:(\d+)/.exec(a);if(c){const d=parseInt(c[1]);return t.toUpperCase()+`

`+a+`

`+ob(s.getShaderSource(e),d)}else return a}function lb(s,e){const t=ab(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const cb={[$_]:"Linear",[Z_]:"Reinhard",[J_]:"Cineon",[vh]:"ACESFilmic",[e0]:"AgX",[t0]:"Neutral",[Q_]:"Custom"};function ub(s,e){const t=cb[e];return t===void 0?($e("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Tc=new j;function db(){Et.getLuminanceCoefficients(Tc);const s=Tc.x.toFixed(4),e=Tc.y.toFixed(4),t=Tc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function fb(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Fa).join(`
`)}function hb(s){const e=[];for(const t in s){const i=s[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function pb(s,e){const t={},i=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let o=0;o<i;o++){const a=s.getActiveAttrib(e,o),c=a.name;let d=1;a.type===s.FLOAT_MAT2&&(d=2),a.type===s.FLOAT_MAT3&&(d=3),a.type===s.FLOAT_MAT4&&(d=4),t[c]={type:a.type,location:s.getAttribLocation(e,c),locationSize:d}}return t}function Fa(s){return s!==""}function C_(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function P_(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const mb=/^[ \t]*#include +<([\w\d./]+)>/gm;function hh(s){return s.replace(mb,_b)}const gb=new Map;function _b(s,e){let t=mt[e];if(t===void 0){const i=gb.get(e);if(i!==void 0)t=mt[i],$e('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return hh(t)}const vb=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function L_(s){return s.replace(vb,xb)}function xb(s,e,t,i){let o="";for(let a=parseInt(e);a<parseInt(t);a++)o+=i.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return o}function N_(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}const yb={[bc]:"SHADOWMAP_TYPE_PCF",[Da]:"SHADOWMAP_TYPE_VSM"};function Sb(s){return yb[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Mb={[Cs]:"ENVMAP_TYPE_CUBE",[wo]:"ENVMAP_TYPE_CUBE",[Hc]:"ENVMAP_TYPE_CUBE_UV"};function Eb(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":Mb[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const Tb={[wo]:"ENVMAP_MODE_REFRACTION"};function wb(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":Tb[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const bb={[q_]:"ENVMAP_BLENDING_MULTIPLY",[my]:"ENVMAP_BLENDING_MIX",[gy]:"ENVMAP_BLENDING_ADD"};function Ab(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":bb[s.combine]||"ENVMAP_BLENDING_NONE"}function Rb(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function Cb(s,e,t,i){const o=s.getContext(),a=t.defines;let c=t.vertexShader,d=t.fragmentShader;const f=Sb(t),h=Eb(t),g=wb(t),_=Ab(t),m=Rb(t),x=fb(t),M=hb(a),T=o.createProgram();let y,S,R=t.glslVersion?"#version "+t.glslVersion+`
...
Program Info Log: `+G+`
`+ae+`
`+U)}else G!==""?$e("WebGLProgram: Program Info Log:",G):(ie===""||Y==="")&&(le=!1);le&&(F.diagnostics={runnable:K,programLog:G,vertexShader:{log:ie,prefix:y},fragmentShader:{log:Y,prefix:S}})}o.deleteShader(k),o.deleteShader(N),b=new Nc(o,T),D=pb(o,T)}let b;this.getUniforms=function(){return b===void 0&&O(this),b};let D;this.getAttributes=function(){return D===void 0&&O(this),D};let X=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return X===!1&&(X=o.getProgramParameter(T,rb)),X},this.destroy=function(){i.releaseStatesOfProgram(this),o.deleteProgram(T),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=sb++,this.cacheKey=e,this.usedTimes=1,this.program=T,this.vertexShader=k,this.fragmentShader=N,this}let Pb=0;class Lb{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,o=this._getShaderStage(t),a=this._getShaderStage(i),c=this._getShaderCacheForMaterial(e);return c.has(o)===!1&&(c.add(o),o.usedTimes++),c.has(a)===!1&&(c.add(a),a.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new Nb(e),t.set(e,i)),i}}class Nb{constructor(e){this.id=Pb++,this.code=e,this.usedTimes=0}}function Ib(s){return s===Ps||s===Uc||s===Fc}function Db(s,e,t,i,o,a){const c=new p0,d=new Lb,f=new Set,h=[],g=new Map,_=i.logarithmicDepthBuffer;let m=i.precision;const x={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function M(b){return f.add(b),b===0?"uv":`uv${b}`}function T(b,D,X,F,$,ce){const de=F.fog,G=$.geometry,ie=b.isMeshStandardMaterial||b.isMeshLambertMaterial||b.isMeshPhongMaterial?F.environment:null,Y=b.isMeshStandardMaterial||b.isMeshLambertMaterial&&!b.envMap||b.isMeshPhongMaterial&&!b.envMap,K=e.get(b.envMap||ie,Y),le=K&&K.mapping===Hc?K.image.height:null,ae=x[b.type];b.precision!==null&&(m=i.getMaxPrecision(b.precision),m!==b.precision&&$e("WebGLProgram.getParameters:",b.precision,"not supported, using",m,"instead."));const U=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,ee=U!==void 0?U.length:0;let Fe=0;G.morphAttributes.position!==void 0&&(Fe=1),G.morphAttributes.normal!==void 0&&(Fe=2),G.morphAttributes.color!==void 0&&(Fe=3);let He,Ie,oe,ye;if(ae){const ot=Gi[ae];He=ot.vertexShader,Ie=ot.fragmentShader}else He=b.vertexShader,Ie=b.fragmentShader,d.update(b),oe=d.getVertexShaderID(b),ye=d.getFragmentShaderID(b);const me=s.getRenderTarget(),De=s.state.buffers.depth.getReversed(),Je=$.isInstancedMesh===!0,Qe=$.isBatchedMesh===!0,Vt=!!b.map,ft=!!b.matcap,bt=!!K,Ot=!!b.aoMap,ht=!!b.lightMap,Jt=!!b.bumpMap,Ht=!!b.normalMap,Mn=!!b.displacementMap,V=!!b.emissiveMap,Gt=!!b.metalnessMap,pt=!!b.roughnessMap,Lt=b.anisotropy>0,Le=b.clearcoat>0,Xt=b.dispersion>0,C=b.iridescence>0,E=b.sheen>0,q=b.transmission>0,he=Lt&&!!b.anisotropyMap,ge=Le&&!!b.clearcoatMap,Me=Le&&!!b.clearcoatNormalMap,Pe=Le&&!!b.clearcoatRoughnessMap,ue=C&&!!b.iridescenceMap,pe=C&&!!b.iridescenceThicknessMap,Ue=E&&!!b.sheenColorMap,ke=E&&!!b.sheenRoughnessMap,be=!!b.specularMap,Ee=!!b.specularColorMap,it=!!b.specularIntensityMap,st=q&&!!b.transmissionMap,gt=q&&!!b.thicknessMap,z=!!b.gradientMap,we=!!b.alphaMap,fe=b.alphaTest>0,Oe=!!b.alphaHash,Re=!!b.extensions;let _e=Yi;b.toneMapped&&(me===null||me.isXRRenderTarget===!0)&&(_e=s.toneMapping);const je={shaderID:ae,shaderType:b.type,shaderName:b.name,vertexShader:He,fragmentShader:Ie,defines:b.defines,customVertexShaderID:oe,customFragmentShaderID:ye,isRawShaderMaterial:b.isRawShaderMaterial===!0,glslVersion:b.glslVersion,precision:m,batching:Qe,batchingColor:Qe&&$._colorsTexture!==null,instancing:Je,instancingColor:Je&&$.instanceColor!==null,instancingMorph:Je&&$.morphTexture!==null,outputColorSpace:me===null?s.outputColorSpace:me.isXRRenderTarget===!0?me.texture.colorSpace:Et.workingColorSpace,alphaToCoverage:!!b.alphaToCoverage,map:Vt,matcap:ft,envMap:bt,envMapMode:bt&&K.mapping,envMapCubeUVHeight:le,aoMap:Ot,lightMap:ht,bumpMap:Jt,normalMap:Ht,displacementMap:Mn,emissiveMap:V,normalMapObjectSpace:Ht&&b.normalMapType===Sy,normalMapTangentSpace:Ht&&b.normalMapType===oh,packedNormalMap:Ht&&b.normalMapType===oh&&Ib(b.normalMap.format),metalnessMap:Gt,roughnessMap:pt,anisotropy:Lt,anisotropyMap:he,clearcoat:Le,clearcoatMap:ge,clearcoatNormalMap:Me,clearcoatRoughnessMap:Pe,dispersion:Xt,iridescence:C,iridescenceMap:ue,iridescenceThicknessMap:pe,sheen:E,sheenColorMap:Ue,sheenRoughnessMap:ke,specularMap:be,specularColorMap:Ee,specularIntensityMap:it,transmission:q,transmissionMap:st,thicknessMap:gt,gradientMap:z,opaque:b.transparent===!1&&b.blending===So&&b.alphaToCoverage===!1,alphaMap:we,alphaTest:fe,alphaHash:Oe,combine:b.combine,mapUv:Vt&&M(b.map.channel),aoMapUv:Ot&&M(b.aoMap.channel),lightMapUv:ht&&M(b.lightMap.channel),bumpMapUv:Jt&&M(b.bumpMap.channel),normalMapUv:Ht&&M(b.normalMap.channel),displacementMapUv:Mn&&M(b.displacementMap.channel),emissiveMapUv:V&&M(b.emissiveMap.channel),metalnessMapUv:Gt&&M(b.metalnessMap.channel),roughnessMapUv:pt&&M(b.roughnessMap.channel),anisotropyMapUv:he&&M(b.anisotropyMap.channel),clearcoatMapUv:ge&&M(b.clearcoatMap.channel),clearcoatNormalMapUv:Me&&M(b.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Pe&&M(b.clearcoatRoughnessMap.channel),iridescenceMapUv:ue&&M(b.iridescenceMap.channel),iridescenceThicknessMapUv:pe&&M(b.iridescenceThicknessMap.channel),sheenColorMapUv:Ue&&M(b.sheenColorMap.channel),sheenRoughnessMapUv:ke&&M(b.sheenRoughnessMap.channel),specularMapUv:be&&M(b.specularMap.channel),specularColorMapUv:Ee&&M(b.specularColorMap.channel),specularIntensityMapUv:it&&M(b.specularIntensityMap.channel),transmissionMapUv:st&&M(b.transmissionMap.channel),thicknessMapUv:gt&&M(b.thicknessMap.channel),alphaMapUv:we&&M(b.alphaMap.channel),vertexTangents:!!G.attributes.tangent&&(Ht||Lt),vertexNormals:!!G.attributes.normal,vertexColors:b.vertexColors,vertexAlphas:b.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,pointsUvs:$.isPoints===!0&&!!G.attributes.uv&&(Vt||we),fog:!!de,useFog:b.fog===!0,fogExp2:!!de&&de.isFogExp2,flatShading:b.wireframe===!1&&(b.flatShading===!0||G.attributes.normal===void 0&&Ht===!1&&(b.isMeshLambertMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isMeshPhysicalMaterial)),sizeAttenuation:b.sizeAttenuation===!0,logarithmicDepthBuffer:_,reversedDepthBuffer:De,skinning:$.isSkinnedMesh===!0,morphTargets:G.morphAttributes.position!==void 0,morphNormals:G.morphAttributes.normal!==void 0,morphColors:G.morphAttributes.color!==void 0,morphTargetsCount:ee,morphTextureStride:Fe,numDirLights:D.directional.length,numPointLights:D.point.length,numSpotLights:D.spot.length,numSpotLightMaps:D.spotLightMap.length,numRectAreaLights:D.rectArea.length,numHemiLights:D.hemi.length,numDirLightShadows:D.directionalShadowMap.length,numPointLightShadows:D.pointShadowMap.length,numSpotLightShadows:D.spotShadowMap.length,numSpotLightShadowsWithMaps:D.numSpotLightShadowsWithMaps,numLightProbes:D.numLightProbes,numLightProbeGrids:ce.length,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:b.dithering,shadowMapEnabled:s.shadowMap.enabled&&X.length>0,shadowMapType:s.shadowMap.type,toneMapping:_e,decodeVideoTexture:Vt&&b.map.isVideoTexture===!0&&Et.getTransfer(b.map.colorSpace)===Dt,decodeVideoTextureEmissive:V&&b.emissiveMap.isVideoTexture===!0&&Et.getTransfer(b.emissiveMap.colorSpace)===Dt,premultipliedAlpha:b.premultipliedAlpha,doubleSided:b.side===Wi,flipSided:b.side===qn,useDepthPacking:b.depthPacking>=0,depthPacking:b.depthPacking||0,index0AttributeName:b.index0AttributeName,extensionClipCullDistance:Re&&b.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Re&&b.extensions.multiDraw===!0||Qe)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:b.customProgramCacheKey()};return je.vertexUv1s=f.has(1),je.vertexUv2s=f.has(2),je.vertexUv3s=f.has(3),f.clear(),je}function y(b){const D=[];if(b.shaderID?D.push(b.shaderID):(D.push(b.customVertexShaderID),D.push(b.customFragmentShaderID)),b.defines!==void 0)for(const X in b.defines)D.push(X),D.push(b.defines[X]);return b.isRawShaderMaterial===!1&&(S(D,b),R(D,b),D.push(s.outputColorSpace)),D.push(b.customProgramCacheKey),D.join()}function S(b,D){b.push(D.precision),b.push(D.outputColorSpace),b.push(D.envMapMode),b.push(D.envMapCubeUVHeight),b.push(D.mapUv),b.push(D.alphaMapUv),b.push(D.lightMapUv),b.push(D.aoMapUv),b.push(D.bumpMapUv),b.push(D.normalMapUv),b.push(D.displacementMapUv),b.push(D.emissiveMapUv),b.push(D.metalnessMapUv),b.push(D.roughnessMapUv),b.push(D.anisotropyMapUv),b.push(D.clearcoatMapUv),b.push(D.clearcoatNormalMapUv),b.push(D.clearcoatRoughnessMapUv),b.push(D.iridescenceMapUv),b.push(D.iridescenceThicknessMapUv),b.push(D.sheenColorMapUv),b.push(D.sheenRoughnessMapUv),b.push(D.specularMapUv),b.push(D.specularColorMapUv),b.push(D.specularIntensityMapUv),b.push(D.transmissionMapUv),b.push(D.thicknessMapUv),b.push(D.combine),b.push(D.fogExp2),b.push(D.sizeAttenuation),b.push(D.morphTargetsCount),b.push(D.morphAttributeCount),b.push(D.numDirLights),b.push(D.numPointLights),b.push(D.numSpotLights),b.push(D.numSpotLightMaps),b.push(D.numHemiLights),b.push(D.numRectAreaLights),b.push(D.numDirLightShadows),b.push(D.numPointLightShadows),b.push(D.numSpotLightShadows),b.push(D.numSpotLightShadowsWithMaps),b.push(D.numLightProbes),b.push(D.shadowMapType),b.push(D.toneMapping),b.push(D.numClippingPlanes),b.push(D.numClipIntersection),b.push(D.depthPacking)}function R(b,D){c.disableAll(),D.instancing&&c.enable(0),D.instancingColor&&c.enable(1),D.instancingMorph&&c.enable(2),D.matcap&&c.enable(3),D.envMap&&c.enable(4),D.normalMapObjectSpace&&c.enable(5),D.normalMapTangentSpace&&c.enable(6),D.clearcoat&&c.enable(7),D.iridescence&&c.enable(8),D.alphaTest&&c.enable(9),D.vertexColors&&c.enable(10),D.vertexAlphas&&c.enable(11),D.vertexUv1s&&c.enable(12),D.vertexUv2s&&c.enable(13),D.vertexUv3s&&c.enable(14),D.vertexTangents&&c.enable(15),D.anisotropy&&c.enable(16),D.alphaHash&&c.enable(17),D.batching&&c.enable(18),D.dispersion&&c.enable(19),D.batchingColor&&c.enable(20),D.gradientMap&&c.enable(21),D.packedNormalMap&&c.enable(22),D.vertexNormals&&c.enable(23),b.push(c.mask),c.disableAll(),D.fog&&c.enable(0),D.useFog&&c.enable(1),D.flatShading&&c.enable(2),D.logarithmicDepthBuffer&&c.enable(3),D.reversedDepthBuffer&&c.enable(4),D.skinning&&c.enable(5),D.morphTargets&&c.enable(6),D.morphNormals&&c.enable(7),D.morphColors&&c.enable(8),D.premultipliedAlpha&&c.enable(9),D.shadowMapEnabled&&c.enable(10),D.doubleSided&&c.enable(11),D.flipSided&&c.enable(12),D.useDepthPacking&&c.enable(13),D.dithering&&c.enable(14),D.transmission&&c.enable(15),D.sheen&&c.enable(16),D.opaque&&c.enable(17),D.pointsUvs&&c.enable(18),D.decodeVideoTexture&&c.enable(19),D.decodeVideoTextureEmissive&&c.enable(20),D.alphaToCoverage&&c.enable(21),D.numLightProbeGrids>0&&c.enable(22),b.push(c.mask)}function L(b){const D=x[b.type];let X;if(D){const F=Gi[D];X=RS.clone(F.uniforms)}else X=b.uniforms;return X}function P(b,D){let X=g.get(D);return X!==void 0?++X.usedTimes:(X=new Cb(s,D,b,o),h.push(X),g.set(D,X)),X}function k(b){if(--b.usedTimes===0){const D=h.indexOf(b);h[D]=h[h.length-1],h.pop(),g.delete(b.cacheKey),b.destroy()}}function N(b){d.remove(b)}function O(){d.dispose()}return{getParameters:T,getProgramCacheKey:y,getUniforms:L,acquireProgram:P,releaseProgram:k,releaseShaderCache:N,programs:h,dispose:O}}function Ub(){let s=new WeakMap;function e(c){return s.has(c)}function t(c){let d=s.get(c);return d===void 0&&(d={},s.set(c,d)),d}function i(c){s.delete(c)}function o(c,d,f){s.get(c)[d]=f}function a(){s=new WeakMap}return{has:e,get:t,remove:i,update:o,dispose:a}}function Fb(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.materialVariant!==e.materialVariant?s.materialVariant-e.materialVariant:s.z!==e.z?s.z-e.z:s.id-e.id}function I_(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function D_(){const s=[];let e=0;const t=[],i=[],o=[];function a(){e=0,t.length=0,i.length=0,o.length=0}function c(m){let x=0;return m.isInstancedMesh&&(x+=2),m.isSkinnedMesh&&(x+=1),x}function d(m,x,M,T,y,S){let R=s[e];return R===void 0?(R={id:m.id,object:m,geometry:x,material:M,materialVariant:c(m),groupOrder:T,renderOrder:m.renderOrder,z:y,group:S},s[e]=R):(R.id=m.id,R.object=m,R.geometry=x,R.material=M,R.materialVariant=c(m),R.groupOrder=T,R.renderOrder=m.renderOrder,R.z=y,R.group=S),e++,R}function f(m,x,M,T,y,S){const R=d(m,x,M,T,y,S);M.transmission>0?i.push(R):M.transparent===!0?o.push(R):t.push(R)}function h(m,x,M,T,y,S){const R=d(m,x,M,T,y,S);M.transmission>0?i.unshift(R):M.transparent===!0?o.unshift(R):t.unshift(R)}function g(m,x){t.length>1&&t.sort(m||Fb),i.length>1&&i.sort(x||I_),o.length>1&&o.sort(x||I_)}function _(){for(let m=e,x=s.length;m<x;m++){const M=s[m];if(M.id===null)break;M.id=null,M.object=null,M.geometry=null,M.material=null,M.group=null}}return{opaque:t,transmissive:i,transparent:o,init:a,push:f,unshift:h,finish:_,sort:g}}function Ob(){let s=new WeakMap;function e(i,o){const a=s.get(i);let c;return a===void 0?(c=new D_,s.set(i,[c])):o>=a.length?(c=new D_,a.push(c)):c=a[o],c}function t(){s=new WeakMap}return{get:e,dispose:t}}function kb(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new j,color:new dt};break;case"SpotLight":t={position:new j,direction:new j,color:new dt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new j,color:new dt,distance:0,decay:0};break;case"HemisphereLight":t={direction:new j,skyColor:new dt,groundColor:new dt};break;case"RectAreaLight":t={color:new dt,position:new j,halfWidth:new j,halfHeight:new j};break}return s[e.id]=t,t}}}function Bb(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new at};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new at};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new at,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=t,t}}}let zb=0;function Vb(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function Hb(s){const e=new kb,t=Bb(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let h=0;h<9;h++)i.probe.push(new j);const o=new j,a=new xt,c=new xt;function d(h){let g=0,_=0,m=0;for(let D=0;D<9;D++)i.probe[D].set(0,0,0);let x=0,M=0,T=0,y=0,S=0,R=0,L=0,P=0,k=0,N=0,O=0;h.sort(Vb);for(let D=0,X=h.length;D<X;D++){const F=h[D],$=F.color,ce=F.intensity,de=F.distance;let G=null;if(F.shadow&&F.shadow.map&&(F.shadow.map.texture.format===Ps?G=F.shadow.map.texture:G=F.shadow.map.depthTexture||F.shadow.map.texture),F.isAmbientLight)g+=$.r*ce,_+=$.g*ce,m+=$.b*ce;else if(F.isLightProbe){for(let ie=0;ie<9;ie++)i.probe[ie].addScaledVector(F.sh.coefficients[ie],ce);O++}else if(F.isDirectionalLight){const ie=e.get(F);if(ie.color.copy(F.color).multiplyScalar(F.intensity),F.castShadow){const Y=F.shadow,K=t.get(F);K.shadowIntensity=Y.intensity,K.shadowBias=Y.bias,K.shadowNormalBias=Y.normalBias,K.shadowRadius=Y.radius,K.shadowMapSize=Y.mapSize,i.directionalShadow[x]=K,i.directionalShadowMap[x]=G,i.directionalShadowMatrix[x]=F.shadow.matrix,R++}i.directional[x]=ie,x++}else if(F.isSpotLight){const ie=e.get(F);ie.position.setFromMatrixPosition(F.matrixWorld),ie.color.copy($).multiplyScalar(ce),ie.distance=de,ie.coneCos=Math.cos(F.angle),ie.penumbraCos=Math.cos(F.angle*(1-F.penumbra)),ie.decay=F.decay,i.spot[T]=ie;const Y=F.shadow;if(F.map&&(i.spotLightMap[k]=F.map,k++,Y.updateMatrices(F),F.castShadow&&N++),i.spotLightMatrix[T]=Y.matrix,F.castShadow){const K=t.get(F);K.shadowIntensity=Y.intensity,K.shadowBias=Y.bias,K.shadowNormalBias=Y.normalBias,K.shadowRadius=Y.radius,K.shadowMapSize=Y.mapSize,i.spotShadow[T]=K,i.spotShadowMap[T]=G,P++}T++}else if(F.isRectAreaLight){const ie=e.get(F);ie.color.copy($).multiplyScalar(ce),ie.halfWidth.set(F.width*.5,0,0),ie.halfHeight.set(0,F.height*.5,0),i.rectArea[y]=ie,y++}else if(F.isPointLight){const ie=e.get(F);if(ie.color.copy(F.color).multiplyScalar(F.intensity),ie.distance=F.distance,ie.decay=F.decay,F.castShadow){const Y=F.shadow,K=t.get(F);K.shadowIntensity=Y.intensity,K.shadowBias=Y.bias,K.shadowNormalBias=Y.normalBias,K.shadowRadius=Y.radius,K.shadowMapSize=Y.mapSize,K.shadowCameraNear=Y.camera.near,K.shadowCameraFar=Y.camera.far,i.pointShadow[M]=K,i.pointShadowMap[M]=G,i.pointShadowMatrix[M]=F.shadow.matrix,L++}i.point[M]=ie,M++}else if(F.isHemisphereLight){const ie=e.get(F);ie.skyColor.copy(F.color).multiplyScalar(ce),ie.groundColor.copy(F.groundColor).multiplyScalar(ce),i.hemi[S]=ie,S++}}y>0&&(s.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=Ne.LTC_FLOAT_1,i.rectAreaLTC2=Ne.LTC_FLOAT_2):(i.rectAreaLTC1=Ne.LTC_HALF_1,i.rectAreaLTC2=Ne.LTC_HALF_2)),i.ambient[0]=g,i.ambient[1]=_,i.ambient[2]=m;const b=i.hash;(b.directionalLength!==x||b.pointLength!==M||b.spotLength!==T||b.rectAreaLength!==y||b.hemiLength!==S||b.numDirectionalShadows!==R||b.numPointShadows!==L||b.numSpotShadows!==P||b.numSpotMaps!==k||b.numLightProbes!==O)&&(i.directional.length=x,i.spot.length=T,i.rectArea.length=y,i.point.length=M,i.hemi.length=S,i.directionalShadow.length=R,i.directionalShadowMap.length=R,i.pointShadow.length=L,i.pointShadowMap.length=L,i.spotShadow.length=P,i.spotShadowMap.length=P,i.directionalShadowMatrix.length=R,i.pointShadowMatrix.length=L,i.spotLightMatrix.length=P+k-N,i.spotLightMap.length=k,i.numSpotLightShadowsWithMaps=N,i.numLightProbes=O,b.directionalLength=x,b.pointLength=M,b.spotLength=T,b.rectAreaLength=y,b.hemiLength=S,b.numDirectionalShadows=R,b.numPointShadows=L,b.numSpotShadows=P,b.numSpotMaps=k,b.numLightProbes=O,i.version=zb++)}function f(h,g){let _=0,m=0,x=0,M=0,T=0;const y=g.matrixWorldInverse;for(let S=0,R=h.length;S<R;S++){const L=h[S];if(L.isDirectionalLight){const P=i.directional[_];P.direction.setFromMatrixPosition(L.matrixWorld),o.setFromMatrixPosition(L.target.matrixWorld),P.direction.sub(o),P.direction.transformDirection(y),_++}else if(L.isSpotLight){const P=i.spot[x];P.position.setFromMatrixPosition(L.matrixWorld),P.position.applyMatrix4(y),P.direction.setFromMatrixPosition(L.matrixWorld),o.setFromMatrixPosition(L.target.matrixWorld),P.direction.sub(o),P.direction.transformDirection(y),x++}else if(L.isRectAreaLight){const P=i.rectArea[M];P.position.setFromMatrixPosition(L.matrixWorld),P.position.applyMatrix4(y),c.identity(),a.copy(L.matrixWorld),a.premultiply(y),c.extractRotation(a),P.halfWidth.set(L.width*.5,0,0),P.halfHeight.set(0,L.height*.5,0),P.halfWidth.applyMatrix4(c),P.halfHeight.applyMatrix4(c),M++}else if(L.isPointLight){const P=i.point[m];P.position.setFromMatrixPosition(L.matrixWorld),P.position.applyMatrix4(y),m++}else if(L.isHemisphereLight){const P=i.hemi[T];P.direction.setFromMatrixPosition(L.matrixWorld),P.direction.transformDirection(y),T++}}}return{setup:d,setupView:f,state:i}}function U_(s){const e=new Hb(s),t=[],i=[],o=[];function a(m){_.camera=m,t.length=0,i.length=0,o.length=0}function c(m){t.push(m)}function d(m){i.push(m)}function f(m){o.push(m)}function h(){e.setup(t)}function g(m){e.setupView(t,m)}const _={lightsArray:t,shadowsArray:i,lightProbeGridArray:o,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:a,state:_,setupLights:h,setupLightsView:g,pushLight:c,pushShadow:d,pushLightProbeGrid:f}}function Gb(s){let e=new WeakMap;function t(o,a=0){const c=e.get(o);let d;return c===void 0?(d=new U_(s),e.set(o,[d])):a>=c.length?(d=new U_(s),c.push(d)):d=c[a],d}function i(){e=new WeakMap}return{get:t,dispose:i}}const Wb=`void main() {
	gl_Position = vec4( position, 1.0 );
