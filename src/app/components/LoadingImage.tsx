...
export default function LoadingImage({ src, alt, className = "", imageClassName = "", onClick }: LoadingImageProps) {
  ...
  return (
    <div className={`relative flex items-center justify-center bg-[#111] overflow-hidden ${className}`}>
      ...
      <img
        ...
        className={`absolute inset-0 w-full h-full transition-opacity duration-700 ease-in-out z-10 ${imageClassName || "object-cover"} ${
